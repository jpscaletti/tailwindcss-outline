...
TailwindCSS plugins to create outline utility classes, analog to those for border.
...
You can control which variants are generated for the outline style utilities by modifying the `outlineWidth`, `outlineStyle`, `outlineOffset`, and/or `outlineColor` property in the `variants` section of your `tailwind.config.js` file.
